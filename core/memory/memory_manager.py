...
class MemoryManager:
    ...
    def _restore_from_database(self) -> None:
        """
        Load persistent memory from SQLite into runtime memory.
        """

        try:
            episodic_data = self.store.load_episodes()

            semantic_data = self.store.load_knowledge()
    ...
    def clear_all(self) -> None:
        ...
        for knowledge in self.store.load_knowledge():
